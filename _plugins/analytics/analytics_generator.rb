...
module Jekyll
  class AnalyticsGenerator < Generator
    ...
    def generate(site)
      ...
      site.data['analytics'] = analytics

      Jekyll.logger.info 'Analytics Generator:', 'Generated analytics schemas'
    rescue StandardError => e
      Jekyll.logger.warn 'Analytics Generator:', "Error: #{e.message}"
      Jekyll.logger.debug 'Analytics Generator:', e.backtrace.join("\n")
    end

    private

    def generate_event_schemas(_site)
      events = []
      ...
      events << {
        ...
        'category' => 'terminal',
        'parameters' => %w[command args timestamp],
      ...
      events << {
        'name' => 'page_view',
        'category' => 'navigation',
        'parameters' => %w[page referrer timestamp],
      ...
      events << {
        'name' => 'project_click',
        'category' => 'engagement',
        'parameters' => %w[project_name project_url source],
      ...
      events << {
        'name' => 'theme_change',
        'category' => 'preference',
        'parameters' => %w[theme_name previous_theme],
    ...
    def generate_metrics(site)
...

      {
        ...
        'engagement' => {
          'terminal_commands' => %w[help whoami companies repos skills],
